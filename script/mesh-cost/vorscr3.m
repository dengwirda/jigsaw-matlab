function [cscr] = vorscr3(pp,pw,t3)
%VORSCR3 calc. a dual grid quality metric for triangles in a 
%3-simplex triangulation in R^3.
%   [SCR3] = VORSCR3(VERT,VPWR,TRIA) returns the dual metric
